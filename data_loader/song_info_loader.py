...
class SongMetaInfoLoader(object):
    ...
    def make_song_tag_info(self, playlist_data, top_n):
    ...
    def make_song_metainfo_map(self, meta_data, top_n):
    ...
    def make_info_map(self, playlist_data, meta_data, top_n=5):
        ...
        self.make_song_tag_info(playlist_data=playlist_data, top_n=top_n)
        self.make_song_metainfo_map(meta_data=meta_data, top_n=5)
        print('done!')
